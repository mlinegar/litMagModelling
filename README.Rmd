...
# in the case of our example, this looked like: dataFolder <- "~/Dropbox/The Egoist PDFs/Stripped_XML"
pattern <- ".txt"
...
# here is our stopword file: stopListFile <- "~/Dropbox/The Egoist PDFs/workingfolder/stoplistFoRealz0.txt"
stopListFile = "~/Path/to/stopwords.txt"
trained_marz <- make_model(marz, n.topics = ntopics, stopListFile = stopListFile)
# now we convert to a data.frame for easy graphing
trained_marz.df <- modelToDataframe(trained_marz, marz, num.topwords = numtopwords, n.topics = ntopics)
```
